...
% Actual Drawing
\node (m3) [mass,minimum width=1.5cm,minimum height=1cm] {$m_3$};
\node (m2) at (m3.south) [mass,yshift=-1.5cm,anchor=north,minimum width=1.5cm,minimum height=1cm] {$m_2$};
...
\draw [spring] (m2.135) -- ($(m3.south east)!(m2.135)!(m3.south west)$) node[midway, left]{$k_3$};
\draw [damper] (m2.45) -- ($(m3.south east)!(m2.45)!(m3.south west)$) node[midway, right,xshift=2mm]{$c_3$};
